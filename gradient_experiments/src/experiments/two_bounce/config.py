...
class Config:
    ...
    init_vel: jnp.ndarray = jnp.array([5.0, -2.5])  # Initial velocity of the ball
    ctrl_input: jnp.ndarray = jnp.array([0.0, 0.0])

# --- Load model and data ---
xml_path = "/Users/hashim/Desktop/Dissertation/GradientExperiments/src/experiments/two_bounce/ball.xml"
