...
"""
Modifying MuJoCo's Solver File to allow for Implicit Differentiation
"""
...
def implicit_jaxopt_solve(m: Model, d: Data) -> Data:
    ...
    def residual(qacc: jax.Array, m: Model, d: Data) -> jax.Array:
        """
        Defines the root function, ensuring optimality:
    ...
    @implicit_diff.custom_root(optimality_fun=residual, has_aux=True)
